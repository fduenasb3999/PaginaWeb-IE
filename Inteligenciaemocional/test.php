...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            ...
            <hr>
                Serás evaluado en los siguientes ámbitos:
            <ul>
                <li> Percepción y evaluación de emociones </li>
                <li> Uso de emociones como facilitadores del pensamiento </li>
                <li> Regulación de las emociones </li>
                <li> Gestión de emociones propias </li>
                <li> Gestión de emociones de otras personas </li>
            </ul>                      
        </div>
        <div class="col-md-6" >
            <figure>
...
<section id="test">
    <div class="container text-center">
        ...
        <p class="mensaje-incial">Para medir tu inteligencia emocional, encontrarás 35 afirmaciones asociadas a tus emociones o a las reacciones asociadas a tus emociones. ¡Elige la respuesta que mejor te describa!</p>
    ...
    <div id="answerBank">
        <h2>Tus Resultados</h2>
            ...
            <p>Percepción y evaluación de emociones: <span id="scoreA"></span></p>
            <hr>
            <p>Uso de emociones como facilitadores del pensamiento<span id="scoreB"></span></p>
            <hr>
            <p>Regulación de las emociones<span id="scoreC"></span></p>
            <hr>
            <p>Gestión de emociones propias<span id="scoreD"></span></p>
            <hr>
            <p>Gestión de emociones de otras personas<span id="scoreE"></span></p>
            <hr>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 footer-box">
                ...
                <aside>
                <p> Emotion.IA es una compañia que busca tu bienestar emocional apoyada en las tecnologías digitales.</p>
            </aside>
            </div>
            <div class="col-md-4 footer-box">
                <p><b>CONTÁCTANOS</b></p>
            ...
            <div class="col-md-4 footer-box">
                <form>
                    <div class="mb-3">
                     <p> <label for="email-ejemplo">Correo electrónico</label></p>
                      <input type="email" class="form-control" id="email-ejemplo" aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Podrás eliminar la susbcripción cuando desees</div>
                    </div>
                    <div class="mb-3">
        ...
        <hr>
        <p class="copyright" >Sitio web creado por Bryan Garcia M. Imágenes de: <a href="https://storyset.com/worker">Worker illustrations by Storyset</a> Logo por: <a href="https://www.instagram.com/rempo.art">@rempo.art</a></p>
    </div>
</section>
</footer>
<!-----------------------------------smooth scroll--------------------------------------->
